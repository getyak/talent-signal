...
const documentReference=args.length===6&&args[4]==="--fixture"&&args[5]==="document-reference";
assert((args.length===4||documentReference)&&args[0]==="--database"&&args[2]==="--output","Expected --database owned URL --output receipt path [--fixture document-reference]");
...
const bytes=await sharp(Buffer.from(`<svg xmlns="http://www.w3.org/2000/svg" width="700" height="9000"><rect width="700" height="9000" fill="white"/><g font-family="sans-serif" fill="black"><text x="30" y="50" font-size="30">Synthetic public comment thread</text><text x="30" y="8530" font-size="24">Mira: ${documentReference?"Document reference":"Verification code"} ${marker}</text><text x="30" y="8580" font-size="24">Tao: I will check it tomorrow.</text></g></svg>`)).png().toBuffer();
