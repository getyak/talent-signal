  ...
  return <div className={`${styles.page} ${embedded?styles.embedded:""}`}>
    ...
    <main className={styles.layout} id="main-content">
      ...
      <div className={styles.content}>
        <div className={styles.intro}>{personID?<p className={styles.eyebrow}>联系人档案</p>:null}<h1>{personID?personName??"联系人":"来源"}</h1><p>从网页或屏幕留下线索，在这里继续。识别人物、保存来源，把需要判断的地方留给你。</p>
