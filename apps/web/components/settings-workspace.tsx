  ...
  return (
    <div className={styles.pane}>
      <Group
        ...
        title="界面"
      >
        <Row description="跟随系统时不强制覆盖。" title="外观">
          <ThemeChoice />
        </Row>
        <Row description="工作台界面语言。" title="语言">
          <span className={styles.rowValue}>{language === "zh-CN" ? "简体中文" : language}</span>
        </Row>
        <Row
      ...
      >
        {sessionVersion ? (
          <AgentResponsePreference key={sessionVersion} sessionVersion={sessionVersion} />
        ) : (
