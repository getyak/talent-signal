...
export async function GET(){
  ...
  try{
    ...
    return NextResponse.json({status:"ready",workspace_label:claims.backendAccountName,session_version:browserSessionVersion(claims)},{headers:{"cache-control":"no-store"}});
