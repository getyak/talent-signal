...
const routes=[new RegExp(`^tasks(?:/${uuid}(?:/(?:resume|cancel|delete|images/[0-9]))?)?$`),new RegExp(`^people/${uuid}/(?:contact-intelligence|archive)$`),new RegExp(`^archives/${uuid}/restore$`)];
