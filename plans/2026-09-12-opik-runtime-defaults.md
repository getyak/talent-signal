...
Live destination recheck initially timed out under VM memory pressure. Added a dedicated 2 GiB swap file in the existing Colima VM and registered it in its fstab, preserving every running container. Available memory recovered from about 119 MiB to 828 MiB; source-bound trace/context readbacks then returned HTTP 200 in 0.25/0.08 seconds. This is capacity relief, not a claim that unlimited concurrent stacks fit in 6 GiB RAM.
