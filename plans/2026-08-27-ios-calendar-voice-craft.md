...
- The repository-wide localization gate is currently blocked by two missing
  image-upload strings from separate in-progress work. All eight keys added by
  this slice exist with Simplified Chinese translations and compile in Xcode.
