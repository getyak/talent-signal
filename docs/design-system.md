...
Today, Sessions, People, and Meetings form one horizontal pager. The header keeps symbols and touch regions in stable positions across selection and interactive travel. One quiet capsule follows actual progress in LTR and RTL, including cancellation; selection changes emphasis without inserting text or resizing controls. Reduced motion uses selection directly; full accessibility names, selected states, large-content labels and 44-point targets remain available. Only the header observes continuous motion; page search, filters, scroll and calendar disclosure persist.
